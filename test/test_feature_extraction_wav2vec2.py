...
# from transformers import WAV_2_VEC_2_PRETRAINED_MODEL_ARCHIVE_LIST, Wav2Vec2Config
...
from utils.utils import require_torch, WAV_2_VEC_2_PRETRAINED_MODEL_ARCHIVE_LIST #, Wav2Vec2Config
